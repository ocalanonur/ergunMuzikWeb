<%-- 
    Document   : index
    Created on : Mar 17, 2018, 10:23:54 PM
    Author     : Onur
--%>
...
<body class="animsition">
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1" style="background-image: url(images/ergunimages/concert.jpg);">
				...
				<div class="item-slick1 item2-slick1" style="background-image: url(images/ergunimages/concert2.jpg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
				...
				<div class="item-slick1 item3-slick1" style="background-image: url(images/ergunimages/mic3.jpg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
				...
				<div class="col-md-6 p-t-45 p-b-30">
					<div class="wrap-text-welcome t-center">
						...
						<p class="t-center m-b-22 size3 m-l-r-auto">
							2013 tarihinden itibaren müzik sektöründe faaliyet gösteren firmamız bir çok başarıya imza atmıştır. Firmamız 5 yıllık deneyimiyle siz müşterilerimize her türlü organizasyonlarla hizmet vermektedir.
						</p>
	...
	<section class="section-intro">
		<div class="header-intro parallax100 t-center p-t-135 p-b-158" style="background-image: url(images/ergunimages/behringerx32standart.jpg);">
